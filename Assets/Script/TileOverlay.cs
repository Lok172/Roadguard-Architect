...
public class TileOverlay : MonoBehaviour
{
    ...
    private void AnimateGlow()
    {
        ...
        {
            // Unscaled: the glow must keep pulsing even while Time.timeScale
            // is 0 during the Planning Phase pause — otherwise the overlay
            // freezes solid the instant Planning Phase begins.
            _sharedGlowTimer += Time.unscaledDeltaTime * _glowSpeed;
